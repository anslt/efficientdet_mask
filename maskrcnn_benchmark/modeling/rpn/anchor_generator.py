...
class AnchorGenerator(nn.Module):
    ...
    def forward(self, image_list, feature_maps):
        ...
        # TODO: replace with the result from Anchors
        # anchors_over_all_feature_maps = self.anchor_new_generator(image_list, image_list.dtype)
...
def make_anchor_generator_retinanet(config):
    ...
    if config.RETINANET.FEW_ANCHOR:
        anchor_generator = AnchorGenerator(
        anchor_sizes, aspect_ratios, anchor_strides, straddle_thresh
        )
        return anchor_generator
